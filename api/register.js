...
const PLATFORM_SIGNUP_URLS = {
  ...
  // ── NEW SITES (+30) ── BLP 313→343 expansion ─────────────────────────────
  ...
  codeberg:       'https://codeberg.org/user/sign_up',
  neocities:      'https://neocities.org/signup',
  producthunt:    'https://www.producthunt.com/login',
  sourceforge:    'https://sourceforge.net/user/registration',
  kaggle:         'https://www.kaggle.com/account/login?phase=startRegisterTab',
  devpost:        'https://devpost.com/login',
  paperswithcode: 'https://paperswithcode.com/accounts/login/',
  microblog:      'https://micro.blog/login',
  bearblog:       'https://bearblog.dev/signup/',
  mataroa:        'https://mataroa.blog/accounts/register/',
  buttondown:     'https://buttondown.email/register',
  typefully:      'https://typefully.com',
  plume:          'https://plume.social/users/new',
  lobsters:       'https://lobste.rs/login',
  lemmyworld:     'https://lemmy.world/signup',
  kbin:           'https://kbin.social/register',
  stackernews:    'https://stacker.news',
  raindrop:       'https://app.raindrop.io/register',
  luma:           'https://lu.ma/signup',
  lottiefiles:    'https://lottiefiles.com/join',
  launchpad:      'https://login.launchpad.net/+new_account',
  srht:           'https://meta.sr.ht/register',
  pastery:        'https://www.pastery.net/account/register/',
