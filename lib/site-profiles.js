...
const PROFILES = {
  ...
  // ── PASTE SITES (anonymous, no login needed) ─────────────────────────────
  ...
  'telegra.ph': {
    ...
    postSelectors: {
      title: 'input[placeholder="Title"]',
      body: '.tl_article_content,[contenteditable]',
      submit: 'button.tl_button[data-name="publish"]',
      successPattern: /telegra\.ph\/[A-Za-z0-9-]+/,
    },
    anonymous: true,
    preferApi: true,
  ...
  'paste.rs': {
    loginUrl: null,
    postUrl: 'https://paste.rs',
    postType: 'text',
    postSelectors: {
      body: 'textarea,#editor,[contenteditable]',
      submit: '[type="submit"],button:has-text("Paste")',
      successPattern: /paste\.rs\/[a-zA-Z0-9.]+/,
    },
    anonymous: true,
    preferApi: true,
  },
  ...
  'bitbucket.org': {
    ...
    loginSelectors: { user: '#id_username,#username', pass: '#id_password,#password', submit: '[type="submit"]' },
    postUrl: 'https://bitbucket.org/snippets/new',
    postType: 'text',
    postSelectors: {
      title: 'input[name="title"]',
      body: 'textarea,.CodeMirror-code',
      submit: 'button[type="submit"]:has-text("Create")',
      successPattern: /bitbucket\.org\/snippets\/[^/]+\/[a-zA-Z0-9]+/,
    },
    preferApi: true,
  },
  ...
  'jsfiddle.net': {
    ...
    loginSelectors: { user: '#id_username', pass: '#id_password', submit: '[type="submit"]' },
    postUrl: 'https://jsfiddle.net/',
    postType: 'html',
    postSelectors: {
      title: '#mte-description,#id_title',
      body: '#id_html .CodeMirror-code',
      submit: '#run,[name="run"]',
      successPattern: /jsfiddle\.net\/[^/]+\/[a-zA-Z0-9]+/,
    },
    preferApi: true,
  },
  ...
  'getpocket.com': {
    loginUrl: 'https://getpocket.com/login',
    loginSelectors: { user: '#email', pass: '#password', submit: '[type="submit"]' },
    postUrl: 'https://getpocket.com/saves',
    postType: 'text',
    postSelectors: {
      body: 'input[placeholder*="URL"],#url-input',
      submit: '[type="submit"],button:has-text("Save")',
      successPattern: /getpocket\.com/,
    },
    preferApi: true,
  },
  ...
  'instapaper.com': {
    ...
    loginSelectors: { user: 'input[name="username"]', pass: 'input[name="password"]', submit: '[type="submit"]' },
    postUrl: 'https://www.instapaper.com/save',
    postType: 'text',
    postSelectors: {
      body: 'input[name="url"]',
      submit: '[type="submit"]',
      successPattern: /instapaper\.com\/read\//,
    },
    preferApi: true,
  },

  'flipboard.com': {
    loginUrl: 'https://flipboard.com/login',
    loginSelectors: { user: 'input[name="email"],input[type="email"]', pass: 'input[name="password"]', submit: '[type="submit"]' },
    postUrl: 'https://flipboard.com/magazines',
    postType: 'text',
    postSelectors: {
      body: 'input[placeholder*="URL"]',
      submit: '[type="submit"],button:has-text("Add")',
      successPattern: /flipboard\.com/,
    },
    preferApi: true,
  },
  ...
  'diigo.com': {
    ...
    postType: 'text',
    postSelectors: {
      body: '#notes,textarea[name="description"]',
      submit: '#savebtn,[type="submit"]',
      successPattern: /diigo\.com/,
    },
    preferApi: true,
  },
  ...
  'livejournal.com': {
    loginUrl: 'https://www.livejournal.com/login.bml',
    loginSelectors: { user: '#user', pass: '#password', submit: '#login_submit' },
    postUrl: 'https://www.livejournal.com/update.bml',
    postType: 'html',
    postSelectors: {
      title: '#subject',
      body: '#draft,.ql-editor,[contenteditable]',
      submit: '#btn_submit,[name="submitpost"]',
      successPattern: /livejournal\.com\/\d+\.html/,
    },
    preferApi: true,
  },

  'vocal.media': {
    loginUrl: 'https://vocal.media/auth/sign-in',
    loginSelectors: { user: 'input[name="email"],input[type="email"]', pass: 'input[name="password"],input[type="password"]', submit: '[type="submit"]' },
    postUrl: 'https://vocal.media/creators/new-story',
    postType: 'richtext',
    postSelectors: {
      title: 'input[placeholder*="title" i],h1[contenteditable]',
      body: '.ql-editor,[contenteditable="true"]',
      submit: 'button:has-text("Publish"),[type="submit"]',
      successPattern: /vocal\.media\/[^/]+\/[^/]+/,
    },
    preferApi: true,
  ...
  'slashdot.org': {
    loginUrl: 'https://slashdot.org/login.pl',
    loginSelectors: { user: '#unickname', pass: '#upasswd', submit: '[type="submit"]' },
    postUrl: 'https://slashdot.org/journal.pl',
    postType: 'text',
    postSelectors: {
      title: 'input[name="description"]',
      body: 'textarea[name="article"]',
      submit: 'input[value="Save"],[type="submit"]',
      successPattern: /slashdot\.org\/journal\//,
    },
    preferApi: true,
  },
  ...
  'bloglovin.com': {
    loginUrl: 'https://www.bloglovin.com/login',
    loginSelectors: { user: 'input[name="email"]', pass: 'input[name="password"]', submit: '[type="submit"]' },
    postUrl: 'https://www.bloglovin.com',
    postType: 'text',
    postSelectors: {
      body: 'input[placeholder*="URL"],input[name="url"]',
      submit: '[type="submit"]',
      successPattern: /bloglovin\.com/,
    },
    preferApi: true,
  },

  'pearltrees.com': {
    loginUrl: 'https://www.pearltrees.com/login',
    loginSelectors: { user: 'input[name="email"],input[type="email"]', pass: 'input[name="password"]', submit: '[type="submit"]' },
    postUrl: 'https://www.pearltrees.com',
    postType: 'text',
    postSelectors: {
      body: 'input[placeholder*="URL"],input[type="url"]',
      submit: '[type="submit"],button:has-text("Add")',
      successPattern: /pearltrees\.com/,
    },
    preferApi: true,
  },
...
export { PROFILES, getProfile, formatContent, toPlainText, mdToPlain, slug };
